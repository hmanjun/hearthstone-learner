...
train_size = int(185486 * train_ratio)
val_size = int(185486 * val_ratio)
test_size = 185486 - train_size - val_size
current_image = 0
...
def overlay_and_save(mouse_img, x, y, suffix):
...
for x in range(x_start, x_end + 1, 10):
    for y in range(y_start, y_end + 1, 10):
        overlay_and_save(mouse_hover, x, y, "hover")
        overlay_and_save(mouse_closed, x, y, "closed")
